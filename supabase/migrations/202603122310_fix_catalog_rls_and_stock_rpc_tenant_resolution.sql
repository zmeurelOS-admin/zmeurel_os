...
grant select, insert, update, delete on table public.crop_varieties to authenticated;
...
create policy crop_varieties_select
...
create policy crop_varieties_insert
on public.crop_varieties
for insert
to authenticated
with check (
...
create policy crop_varieties_update
on public.crop_varieties
for update
to authenticated
using (
...
create policy crop_varieties_delete
on public.crop_varieties
for delete
to authenticated
using (
...
drop policy if exists crop_varieties_superadmin_all on public.crop_varieties;
create policy crop_varieties_superadmin_all
on public.crop_varieties
for all
to authenticated
