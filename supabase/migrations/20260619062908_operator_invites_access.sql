...
create index if not exists farm_invites_token_idx on public.farm_invites (token);
create index if not exists farm_invites_tenant_id_idx on public.farm_invites (tenant_id);
