...
export function VanzariButasiPageClient({
  ...
  // Fetch vânzări butași
  const { data: vanzari = initialVanzari } = useQuery({
    queryKey: ['vanzari-butasi', tenantId],
    queryFn: () => getVanzariButasi(tenantId),
  ...
  const deleteMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      toast.success('Vânzare butași ștearsă cu succes!');
  ...
  // Handlers
  const handleEdit = (vanzare: VanzareButasi) => {
    setEditingVanzare(vanzare);
  };

  const handleDelete = (vanzare: VanzareButasi) => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <AddVanzareButasiDialog tenantId={tenantId} />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-sm text-gray-600">Total Vânzări Butași</p>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <Input
                  id="search"
                  type="text"
                  placeholder="Caută după ID, soi, client..."
                  value={searchTerm}
          ...
          <CardContent className="p-12 text-center">
            ...
            <p className="text-gray-600 mb-4">
              {searchTerm || selectedMonth !== 'all'
                ...
                : 'Adaugă prima vânzare de butași pentru a începe tracking-ul veniturilor'}
            </p>
          </CardContent>
        </Card>
      ) : (
