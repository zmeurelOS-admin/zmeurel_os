          ...
          <div className="flex items-center gap-2" onClick={(event) => event.stopPropagation()}>
            ...
            {onClick ? (
              <Button
                type="button"
                size="sm"
                className="w-auto rounded-xl bg-[var(--agri-primary)] px-4 py-2 text-sm font-semibold text-white hover:opacity-90"
                onClick={onClick}
              >
                Vezi plan
              </Button>
        ...
        {actionsOpen ? (
          <div className="grid gap-2 border-t border-[var(--divider)] pt-3" onClick={(event) => event.stopPropagation()}>
            ...
            <Button
              type="button"
              variant="outline"
              className="justify-start text-[var(--status-danger-text)]"
              onClick={onSterge}
            >
