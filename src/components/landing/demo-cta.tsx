  ...
  return (
    <SectionShell id="demo" label="Call to action demo" className="bg-white py-16 md:py-24">
      <div
        ...
        style={{ backgroundImage: 'linear-gradient(135deg, #3D7A5F 0%, #40916C 100%)' }}
      >
        ...
        <div className="mt-8 flex flex-col gap-3 sm:flex-row">
          <Link
            href="/start"
            className="rounded-xl bg-white px-6 py-3 text-center text-sm font-semibold text-[#3D7A5F] transition hover:bg-[#F5F5F5] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#3D7A5F]"
          >
            Încearcă gratuit
          </Link>
          <a
            ...
            className="rounded-xl border border-white/30 bg-white/15 px-6 py-3 text-center text-sm font-semibold text-white transition hover:bg-white/20 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#3D7A5F]"
          >
            WhatsApp
          </a>
        </div>
