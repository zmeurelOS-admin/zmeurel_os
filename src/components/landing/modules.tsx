...
function ScenarioCard({
  ...
  return (
    <div className="rounded-[30px] bg-[linear-gradient(135deg,rgba(255,255,255,0.7),rgba(241,107,107,0.14),rgba(47,111,78,0.14))] p-px shadow-[0_20px_56px_rgba(49,46,63,0.08)] transition-transform duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_28px_68px_rgba(49,46,63,0.14)]">
      <div className="rounded-[29px] border border-white/70 bg-white p-6">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-3">
          {stats.map((stat) => {
            ...
            return (
              <div
                key={stat.label}
                className="rounded-2xl border border-[color:rgba(49,46,63,0.08)] bg-[rgba(247,248,250,0.86)] p-4 transition-transform duration-300 hover:-translate-y-1 hover:scale-[1.02] hover:shadow-[0_18px_42px_rgba(49,46,63,0.08)]"
              >
