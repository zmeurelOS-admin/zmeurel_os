...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-[#FAFAF6] text-slate-800">
      <a
        href="#main-content"
        className="sr-only fixed left-4 top-4 z-[60] rounded-xl bg-white px-4 py-3 text-sm font-semibold text-slate-900 shadow-lg focus:not-sr-only focus:outline-none focus:ring-2 focus:ring-[#3D7A5F] focus:ring-offset-2"
      >
        Sari la conținut
      </a>
      <LandingHeader />
