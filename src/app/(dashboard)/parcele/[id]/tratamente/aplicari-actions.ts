...
function revalidateAplicarePaths(parcelaId: string) {
...
export async function markAplicataAction(formData: FormData): Promise<ActionResult> {
  ...
  try {
    ...
    revalidateAplicarePaths(parsed.data.parcelaId)
    return { ok: true }
  } catch (error) {
    return {
      ok: false,
...
export async function salveazaCiornaAction(
  ...
  try {
    ...
    revalidateAplicarePaths(aplicare.parcela_id)
    return { ok: true }
  } catch (error) {
    return {
      ok: false,
...
export async function deleteAplicareAction(aplicareId: string, parcelaId: string): Promise<ActionResult> {
  ...
  try {
    ...
    revalidateAplicarePaths(parcelaId)
    return { ok: true }
  } catch (error) {
    return {
      ok: false,
