...
export default async function TratamentePlanEditorPage({ params }: PageProps) {
  ...
  return (
    <AppShell
      header={
        <PageHeader
          title={`${plan.nume} · Editor`}
          subtitle="Editează intervențiile planificate"
          expandRightSlotOnMobile
          rightSlot={
            <Button type="button" asChild>
              <Link href="/tratamente/planuri">Salvează și ieși</Link>
            </Button>
          }
          summary={
            <PlanDetailHeader
