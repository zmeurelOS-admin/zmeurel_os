...
describe('stadii-canonic', () => {
  ...
  it('leagă codurile de culturi canonice de grupurile biologice', () => {
    ...
    expect(getGrupBiologicForCropCod('goji')).toBe('arbusti_fara_cane')
    expect(getGrupBiologicForCropCod('aronia')).toBe('arbusti_fara_cane')
    expect(getGrupBiologicForCropCod('catina')).toBe('arbusti_fara_cane')
    expect(getGrupBiologicForCropCod('alun')).toBe('nucifere')
    expect(getGrupBiologicForCropCod('rosie')).toBe('solanacee')
    expect(getGrupBiologicForCropCod('cartof')).toBe('solanacee')
    expect(getGrupBiologicForCropCod('varza')).toBe('brassicaceae')
    expect(getGrupBiologicForCropCod('ceapa')).toBe('allium')
    expect(getGrupBiologicForCropCod('fasole')).toBe('leguminoase')
    expect(getGrupBiologicForCropCod('mazare')).toBe('leguminoase')
    expect(getGrupBiologicForCropCod('morcov')).toBe('radacinoase')
    expect(getGrupBiologicForCropCod('patrunjel')).toBe('radacinoase')
    expect(getGrupBiologicForCropCod('telina')).toBe('radacinoase')
